...
<body>
    ...
    <div class="section">
        ...
        while ($row = mysqli_fetch_row($result)) {
            print("<form class='product' method='post' action='delete_zaza.php' onclick='myFunction()'>");
            print("<input type='submit' class='button' value='X'></input><br>");
            $x = 0;
