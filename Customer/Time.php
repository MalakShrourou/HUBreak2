...
<body>
        ...
        while ($row = mysqli_fetch_row($result)) {
            foreach ($row as $value) {
                if ($value == 1) {
                    ...
                    $Q1 = "SELECT TotalPrice,Time FROM carts WHERE ResturantID=1";
                    ...
                    $Q2 = "SELECT TotalPrice,Time FROM carts WHERE ResturantID=2";
                    ...
                    while ($row2 = mysqli_fetch_row($result2)) {
                        ...
                        foreach ($row2 as $value) {
                            if ($x == 0) {
                                ...
                                $dbSessionDurationTime2 = $value * 60 * 1000;
                                print("<tr><td id='demo'></td>");
                                print("<td>الوقت المتبقي</td></tr></table></div>");
                            }
                            $x++;
                    ...
                    $Q3 = "SELECT TotalPrice,Time FROM carts WHERE ResturantID=3";
                    ...
                    $Q4 = "SELECT TotalPrice,Time FROM carts WHERE ResturantID=4";
                    ...
                    $Q5 = "SELECT TotalPrice,Time FROM carts WHERE ResturantID=5";
                    ...
                    $Q6 = "SELECT TotalPrice,Time FROM carts WHERE ResturantID=6";
    ...
    <script type="text/javascript">
        ...
        function displaytimer() {
            ...
            document.getElementById("demo").innerHTML = mins + " m " + secs + " s ";
        }
