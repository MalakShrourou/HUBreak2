...
<body>
    <nav>
        <h1>Select a restaurant to BROWES REVIEWS</h1>
    </nav>
    <div class="center">
        <?php
    ...
    while ($row = mysqli_fetch_row($result)) {
      ...
      foreach ($row as $value) {
        if ($x == 0) {
          if ($value == 1) {
            $link = 'ReviewsEastern.php';
          } elseif ($value == 2) {
            $link = 'ReviewsEspresso.php';
          } elseif ($value == 3) {
            $link = 'ReviewsMedicine.php';
          } elseif ($value == 4) {
            $link = 'ReviewsVillage.php';
          } elseif ($value == 5) {
            $link = 'ReviewsZaza.php';
          } elseif ($value == 6) {
            $link = 'ReviewsWestern.php';
          }
        }
        if ($x == 1)
