...
<body>
    ...
    <div class="section">
        ...
        while ($row = mysqli_fetch_row($result)) {
            print("<form class='product' method='post' action='update_zaza.php'>");// onclick='myFunction()
            $x = 0;
            ...
            print("<span class='count'><input type='text' style='margin-right: 1px;' 
            name='new_price' size='5' autocomplete='off'> : السعر الجديد</span><br>
                        <input type='submit' class='button' value='تعديل السعر'></input><br>");
            print("</form>");
        }
