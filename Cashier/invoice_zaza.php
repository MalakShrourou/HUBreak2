...
<body>
                    ...
                    <div class="p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                                <?php
                                $q = "select ID from carts where ResturantID = 5";
                        ...
                        <div class="row">
                            <table id="receipt_bill" class="table">
                                ...
                                <tbody id="new">
                                    <?php
                                    $query = "select orders.price,products.Name from products join orders on products.ID = orders.ProductID where ResturantID =5";
                        ...
                        <div style="margin-left:65%;">
                            <?php
                            $qq = "select Description from carts where resturantId = 5";
    ...
    <form method="post">
        ...
        $qu2 = "delete from orders where resturantid=5 and frompos=1";
