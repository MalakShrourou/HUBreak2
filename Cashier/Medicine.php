...
<body>
    <div class="main">
        ...
        <div class="calculate">
            ...
            if (!$database = mysqli_connect("localhost", "root", "12345678", "hubreak2_db"))
                die("Sorry, could not connect to the server.");
            extract($_POST);
            $query = "select orders.ID,price,name from Orders,products where orders.productId=products.ID and resturantID=3 and frompos=1";
            $result = mysqli_query($database, $query);
    ...
    <div class="inv">
        <?php
        $qq2 = "select ID from carts where resturantId=3 and Payed=0";
