...
<body>
    ...
    <div class="section">
        ...
        extract($_POST);
        $query = "select products.Image,products.ID,products.name,resturantproducts.price,resturantproducts.resturantId from products join resturantproducts on products.ID = productId WHERE resturantproducts.resturantId = 6 ";
