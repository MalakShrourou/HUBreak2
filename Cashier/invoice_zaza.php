                    ...
                    <div class="p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                                <?php
                                $q = "select max(ID) from carts where ResturantID = 5";
                        ...
                        <div class="row">
                            <table id="receipt_bill" class="table">
                                ...
                                <tbody id="new">
                                    <?php
                                    $query = "select orders.price,Quantity,products.Name from products join orders on products.ID = orders.ProductID where ResturantID =5 and payed = 0 and frompos=1";
