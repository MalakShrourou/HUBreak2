...
<body>
                    ...
                    <div class="p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                                <?php
                                $q = "select ID from carts where ResturantID = 6 and payed=0";
                        ...
                        <div class="row">
                            <table id="receipt_bill" class="table">
                                ...
                                <tbody id="new">
                                    <?php
                                    $query = "select orders.price,products.Name from products join orders on products.ID = orders.ProductID where ResturantID =6 and frompos=0";
    ...
    <form method="POST" action="western.php">
        ...
        $qu2 = "delete from orders where resturantid=6";
