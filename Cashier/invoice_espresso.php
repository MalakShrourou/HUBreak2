...
<body>
                    ...
                    <div class="p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                                <?php
                                $q = "select ID from carts where ResturantID = 2";
                        ...
                        <div class="row">
                            <table id="receipt_bill" class="table">
                                ...
                                <tbody id="new">
                                    <?php
                                    $query = "select orders.price,products.Name from products join orders on products.ID = orders.ProductID where ResturantID =2 and frompos=1";
    ...
    <form method="post">
        <input type="submit" formaction="Espresso.php" value="العودة" class="button">
        <?php
        $qu = "delete from carts where payed=1";
        $result = mysqli_query($database, $qu);
        $qu2 = "delete from orders where resturantid=2 and frompos=1";
