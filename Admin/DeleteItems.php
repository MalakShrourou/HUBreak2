...
<body>
    ...
    <div class="head">
        <h1>Select a restaurant to DELETE items from </h1>
    </div>
    <div class="center">
        <?php
        ...
        while ($row = mysqli_fetch_row($result)) {
            ...
            foreach ($row as $value) {
                if ($x == 0) {
                    if ($value == 1) {
                        $link = 'DeleteEastern.php';
                    } elseif ($value == 2) {
                        $link = 'DeleteEspresso.php';
                    } elseif ($value == 3) {
                        $link = 'DeleteMedicine.php';
                    } elseif ($value == 4) {
                        $link = 'DeleteVillage.php';
                    } elseif ($value == 5) {
                        $link = 'DeleteZaza.php';
                    } elseif ($value == 6) {
                        $link = 'DeleteWestern.php';
                    }
                }
                if ($x == 1)
