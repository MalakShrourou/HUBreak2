...
<body>
                    ...
                    <div class="p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                                <?php
                                $q = "SELECT max(ID) from carts where ResturantID = 2 and CustomerID !=8";
                        ...
                        <div class="row">
                            <table id="receipt_bill" class="table">
                                ...
                                <tbody id="new">
                                    <?php
                                    $query = "select orders.price,Quantity,products.Name from products join orders on products.ID = orders.ProductID where ResturantID =2 and frompos=0";
    ...
    <form method="POST" action="espresso.php">
        <input type="submit" onclick="calc()" value="الدفع" class="button">
        <?php
        $query2 = "UPDATE orders SET Payed = 1 where resturantID = 2";
        $result = mysqli_query($database, $query2);
        $query2 = "UPDATE orders2 SET Payed = 1 where resturantID = 2";
        $result = mysqli_query($database, $query2);
