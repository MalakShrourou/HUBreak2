...
<body>
    ...
    <div class="intro">
        <h1>مطاعم الغربي</h1>
        <h3>الموقع : في مجمع القاعات الغربي</h3>
    </div>
    <div class="section">
        <?php
        ...
        extract($_POST);
        $query = "select products.ID,products.Image,products.name,resturantproducts.price,resturantproducts.resturantId from products join resturantproducts on products.ID = productId WHERE resturantproducts.resturantId = 6 ";
    ...
    <div class="rate_sec">
        <div class="show_rate">
            ...
            if (!$database = mysqli_connect("localhost", "root", "12345678", "hubreak2_db"))
                die("Sorry, could not connect to the server.");
            extract($_POST);
            $query = "select Name,rate,comment from rate,customers where customers.ID=rate.customerID and rate.rate >= 3 and  resturantID=6";
