...
<body>
    ...
    <div class="section">
        ...
        extract($_POST);
        $query = "select products.Image,products.ID,products.name,resturantproducts.price,resturantproducts.resturantId from products join resturantproducts on products.ID = productId WHERE resturantproducts.resturantId = 5 ";
    ...
    <div id="display-image">
        ...
        if (!$database = mysqli_connect("localhost", "root", "12345678", "hubreak2_db"))
            die("Sorry, could not connect to the server.");
        extract($_POST);
        $query = "select filename from resturants where ID=5";
        $result = mysqli_query($database, $query);
