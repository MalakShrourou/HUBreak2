...
<body>
    <nav>
        <h1>Select a restaurant to ADD POSTER</h1>
    </nav>
    <div class="center">
        <?php
        ...
        while ($row = mysqli_fetch_row($result)) {
            ...
            foreach ($row as $value) {
                if ($x == 0) {
                    if ($value == 1) {
                        $link = 'SubmitEastern.php';
                    } elseif ($value == 2) {
                        $link = 'SubmitEspresso.php';
                    } elseif ($value == 3) {
                        $link = 'SubmitMedicine.php';
                    } elseif ($value == 4) {
                        $link = 'SubmitVillage.php';
                    } elseif ($value == 5) {
                        $link = 'SubmitZaza.php';
                    } elseif ($value == 6) {
                        $link = 'SubmitWestern.php';
                    }
                }
                if ($x == 1)
